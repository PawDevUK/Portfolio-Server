...
//**@function
/** @name addPDandCoD
/ function checking dates generated by helper functions findPayDays() and findCutOfDays() and adding pay dates and
/ cut off dates to calendar object.
*/
function addPayDay(payDays) {
    // function should loop over calendar object and if date is in payDates objects change payDay for the day to true

    // if date in payDays payDay:true

    return true;
};

function addCutOffDay(cutOffDates) {
    // function should loop over calendar object and if date is in cutOffDates objects change cutOffDay for the day to true
    
    // if date in cutOffDates CutOffDaty:true
